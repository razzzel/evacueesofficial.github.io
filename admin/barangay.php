...
<?php
  ...
  if (isset($_POST['submit'])) {
    ...
    $query = "INSERT INTO brgy_info(name)
    VALUES ('$name')";
...
if(isset($_GET['id'])) {
  $id = $_GET['id'];
  $query = "DELETE FROM brgy_info WHERE id = $id";
  $result = mysqli_query($conn, $query);
  if(!$result) {
    die("Query Failed.");
  }
      ...
      <div class="content-wrapper">
                              ...
                              <div class="row">
                                 <div class="col-md-12">
                                    <div class="form-group">
                                       ...
                                       <input type="text" class="form-control"  placeholder="Barangay name" name="name">
                                    </div>
                                 </div>
                              </div>
                              <div class="col-md-12">
         ...
         <tbody>
          ...
          <tr>
               ...
               <td class="text-right">
               <a class="btn btn-sm btn-success" href="edit-barangay.php?id=<?php echo $row['id']?>"><i class="fa fa-edit"></i> Edit</a>
              <a href="barangay.php?id=<?php echo $row['id']?>" class="btn btn-sm btn-danger">
