...
<?php
  ...
  if (isset($_POST['submit'])) {
    ...
    $query = "INSERT INTO calamity_info(name)
    VALUES ('$name')";
  ...
  header('Location: calamity-type.php');
  }
    

if(isset($_GET['id'])) {
  $id = $_GET['id'];
  $query = "DELETE FROM calamity_info WHERE id = $id";
  $result = mysqli_query($conn, $query);
  if(!$result) {
    die("Query Failed.");
  }
  ...
  echo "Evacuues Removed Successfully";
  header('Location: calamity-type.php');
}
...
<html lang="en">
   ...
   <body class="hold-transition sidebar-mini layout-fixed">
      ...
      <div class="content-wrapper">
                              ...
                              <div class="row">
                                 <div class="col-md-12">
                                    <div class="form-group">
                                       ...
                                       <input type="text" class="form-control" placeholder="Calamity name" name="name">
                                    </div>
                                 </div>
                              </div>
                              <div class="col-md-12">
         ...
         <?php
          $query = "SELECT * FROM calamity_info";
          $cnt=1;
          ...
          <tr>
               ...
               <td class="text-right">
               <a class="btn btn-sm btn-success" href="edit-calimity.php?info=<?php echo $row['id']?>"><i class="fa fa-edit"></i> Edit</a>
              <a href="calamity-type.php?id=<?php echo $row['id']?>" class="btn btn-sm btn-danger">
   ...
   <script src="../asset/tables/datatables/jquery.dataTables.js"></script>
