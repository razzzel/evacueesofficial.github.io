...
if(isset($_POST['update']))
{
   ...
   $email = $_POST['email'];
   $query = mysqli_query($conn, "UPDATE enduser SET username='$username', contactno='$contactno', email='$email' WHERE id='" . $_SESSION['id'] . "'");
   if($query)
   {
      echo "<script>alert('Your info has been updated');</script>";
      // Redirect to a new page after updating the profile
                ...
                <div class="tab-content">
                    <div class="tab-pane fade active show" id="account-general">
                        <div class="card-body text-center">
                            <img src="https://bootdey.com/img/Content/avatar/avatar1.png" alt class="ui-w-100">
                            <label class="btn btn-outline-primary d-block mt-3">
                                Upload new photo
                                <input type="file" class="account-settings-fileinput">
                            </label>
                            <button type="button" class="btn btn-default md-btn-flat d-block mt-2">Reset</button>
                        </div>
                    </div>
                </div>
            </div>
