<?php 
include('update-evac-center.php');
            ...
            <div class="row">
               ...
               <div class="col-md-4">
                  <div class="form-group">
                     ...
                     <input type="text" class="form-control" required placeholder="Center Name" name="name" value="<?php echo $row['name']; ?>">
                  </div>
               </div>
               ...
               <div class="col-md-3">
                  <div class="form-group">
                     ...
                     <input type="number" class="form-control" required placeholder="Contact Number" name="contact" value="<?php echo $row['contact']; ?>">
                  </div>
               </div>                            
              </div>
            </div>
